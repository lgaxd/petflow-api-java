...
-- Sem isso não há como testar a aplicação: não existe tela/endpoint
-- de CRUD para species, event_type, reward_action e risk_level (são
-- tabelas de domínio fixo), e sem um usuário ADMIN ninguém consegue
-- logar pela primeira vez para cadastrar clínicas e planos.
--
